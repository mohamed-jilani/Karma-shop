		...
		<div class="single-product-slider">
			<div class="container">
				...
				<div class="row">
                    ...
                    $requete->execute();
                    $res = $requete->fetchAll();
                    echo "<table class='table'><thead><tr><th scope='col'>Id</th><th scope='col'>reference</th><th scope='col'>nom de produit</th><th scope='col'>quantité en stock</th><th scope='col'>Prix</th><th scope='col'>description</th></tr></thead><tbody>";
                    foreach ($res as $et) { 												
                    
                        echo "<tr><th scope='row'>".$et['id']."</th><td>".$et['ref']."</td><td>".$et['nom_produit']."</td><td>".$et['qtt_p']."</td><td>".$et['prix_p']."</td><td>".$et['description']."</td></tr>";
                    }
                    echo "</body></table>";
                    ?>
